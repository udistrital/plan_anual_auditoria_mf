export const environment = {
  ...
  INFORME_ESTADO: {
    BORRADOR_ID: 7049,
    // INFORME PRELIMINAR
    INFORME_PRELIMINAR_EN_REVISION_POR_JEFE_ID: 7050,
    INFORME_PRELIMINAR_APROBADO_POR_JEFE_ID: 7051,
    INFORME_PRELIMINAR_EN_REVISION_POR_AUDITADO_ID: 7052,
    INFORME_PRELIMINAR_APROBADO_POR_AUDITADO_ID: 7053,
    INFORME_PRELIMINAR_RECHAZADO_POR_JEFE_ID: 7054,
    INFORME_PRELIMINAR_RESPUESTA_POR_AUDITADO_ID: 7055,
    // INFORME FINAL
    INFORME_FINAL_EN_GENEARCION: 7056,
    INFORME_FINAL_EN_REVISION_POR_JEFE_ID: 7057,
    INFORME_FINAL_APROBADO_POR_JEFE_ID: 7058,
    INFORME_FINAL_RECHAZADO_POR_JEFE_ID: 7059
  },
