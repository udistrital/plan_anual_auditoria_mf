export const environment = {
  ...
  TIPO_DOCUMENTO: {
    ...
    ACTA_INICIO_EJECUCION: 194, // POR CONFIRMAR, DE MOMENTO SE USA ID DE ACTA_MODIFICACION
  },

  TIPO_DOCUMENTO_PARAMETROS: {
    ACTA_COMITE_COORDINADOR: 6820,
    MATRIZ_FUNCION_PUBLICA: 6811,
    PLAN_ANUAL_AUDITORIA_ORIGINAL: 6810,
    PLAN_ANUAL_AUDITORIA_ACTUALIZADO: 7094,
    ...
    ACTA_INICIO_EJECUCION: 7095,// POR CONFIRMAR, DE MOMENTO SE USA ID DE ACTA_MODIFICACION
  },
