export const environment = {
  ...
  AUDITORIA_ESTADO: {
    ...
    PLANEACION: {
      ...
      REVISON_PROGRAMA_JEFE: 7064,
      APROBADO_PROGRAMA: 7065,
      RECHAZADO_PROGRAMA: 7066,
    ...
    EJECUCION: {
      ...
      APROBADO_PREINFORME: 7072,
      RECHAZADO_PREINFORME: 7073,
      REVISION_PREINFORME_AUDITADO: 7074,
      APROBADO_PREINFORME_AUDITADO: 7075,
      OBSERVACIONES_PREINFORME: 7076,
      CREANDO_INFORME_FINAL: 7077,
      REVISION_INFORME_FINAL_JEFE: 7078,
      APROBADO_INFORME_FINAL: 7079,
      RECHAZADO_INFORME_FINAL: 7080,
    },
    PLAN_MEJORAMIENTO: {
    ...
    // Estos estados se conservan por compatibilidad con versiones anteriores
    BORRADOR_ID: 6823,
