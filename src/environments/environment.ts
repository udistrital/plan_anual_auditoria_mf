export const environment = {
  ...
  AUDITORIA_ESTADO: {
    ...
    EJECUCION: {
      // INFORME PRELIMINAR
      POR_EJECUTAR: 7069,
      CREANDO_PREINFORME: 7070, // INFORME_PRELIMINAR_CREANDO_ID: 7070,
      REVISION_PREINFORME_JEFE: 7071, // INFORME_PRELIMINAR_EN_REVISION_POR_JEFE_ID: 7071,
      APROBADO_PREINFORME_JEFE: 7072, // INFORME_PRELIMINAR_APROBADO_POR_JEFE_ID: 7072,
      RECHAZADO_PREINFORME_JEFE: 7073, // INFORME_PRELIMINAR_RECHAZADO_POR_JEFE_ID: 7073,
      REVISION_PREINFORME_AUDITADO: 7074, // INFORME_PRELIMINAR_EN_REVISION_POR_AUDITADO_ID: 7074,
      APROBADO_PREINFORME_AUDITADO: 7075, // INFORME_PRELIMINAR_APROBADO_POR_AUDITADO_ID: 7075,
      OBSERVACIONES_PREINFORME_AUDITADO: 7076, // INFORME_PRELIMINAR_RESPUESTA_POR_AUDITADO_ID: 7076,

      // INFORME FINAL
      CREANDO_INFORME_FINAL: 7077, // INFORME_FINAL_CREANDO_ID: 7077,
      REVISION_INFORME_FINAL_JEFE: 7078, // INFORME_FINAL_EN_REVISION_POR_JEFE_ID: 7078,
      APROBADO_INFORME_FINAL_JEFE: 7079, // APROBADO_INFORME_FINAL_ID: 7058 Y INFORME_FINAL_APROBADO_POR_JEFE_ID: 7079,
      RECHAZADO_INFORME_FINAL_JEFE: 7080, // INFORME_FINAL_RECHAZADO_POR_JEFE_ID: 7080
    },
    PLAN_MEJORAMIENTO: {
